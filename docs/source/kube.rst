         ...
         spec:
           ...
           - name: cybersecurityrtms-3f10-ai
             ...
             - name: step9prompt # STEP 9 Enter PGPT prompt
               value: '[INST] Are there any errors or suspicious activity in the log messages found? Give a detailed response, and any resolutions that need to be done.[/INST]'                  
...
.. code-block::
   ...
   http://localhost:6060/dashboard-rtms-ai.html?topic=rtms-pgpt-ai&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. code-block::
   ...
   http://tml.tss/viz/dashboard-rtms-ai.html?topic=rtms-pgpt-ai&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
